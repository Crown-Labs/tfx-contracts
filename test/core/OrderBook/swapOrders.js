    ...
    */
    ...
    it("executeSwapOrder, triggerAboveThreshold == false", async () => {
        ...
        await xOracle.fulfillRequest([
          { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(BTC_PRICE), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(BNB_PRICE - 30), lastUpdate: 0 }
        ], 0)
        ...
        await xOracle.fulfillRequest([
          { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(BTC_PRICE), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(BNB_PRICE - 70), lastUpdate: 0 }
        ], 0)
    ...
    it("executeSwapOrder, triggerAboveThreshold == true", async () => {
        ...
        await xOracle.fulfillRequest([
          { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(60500), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(BNB_PRICE), lastUpdate: 0 }
        ], 0)
        ...
        await xOracle.fulfillRequest([
          { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(62500), lastUpdate: 0 },
          { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(BNB_PRICE), lastUpdate: 0 }
        ], 0)
    ...
    it("executeSwapOrder, triggerAboveThreshold == true, BTC -> USDG", async () => {
        ...
        await xOracle.fulfillRequest([
            { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
            { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(63000), lastUpdate: 0 },
            { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(BNB_PRICE), lastUpdate: 0 }
          ], 0)
        ...
        await xOracle.fulfillRequest([
            { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
            { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(61000), lastUpdate: 0 },
            { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(BNB_PRICE), lastUpdate: 0 }
          ], 0)
    ...
    it("complex scenario", async () => {
        ...
        // execute order 2
        // BTC price decreased relative to BNB
        await increaseBlocktime(provider, 30)
        await fulfillController.requestUpdatePrices()
        await xOracle.fulfillRequest([
            { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
            { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(BTC_PRICE + 1500), lastUpdate: 0 },
            { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(BNB_PRICE + 100), lastUpdate: 0 }
          ], 0)
