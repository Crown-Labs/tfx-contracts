...
//     await glp.setHandler(rewardRouter.address, true)
...
//     await bnb.connect(user1).approve(rewardRouter.address, expandDecimals(2, 18))
...
//     await bnb.connect(user2).approve(rewardRouter.address, expandDecimals(1, 18))
...
//     await rewardRouter.connect(user2).unstakeAndRedeemGlp(
//       bnb.address,
//       expandDecimals(299, 18),
...
//     // revertedWith("GlpManager: cooldown duration not yet passed")
//     await xOracle.fulfillRequest([
//       { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(60000), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(300), lastUpdate: 0 }
...
//     await rewardRouter.connect(user0).mintAndStakeGlpETH(
//       expandDecimals(300, 18), 
//       expandDecimals(300, 18), 
//       { value: expandDecimals(1, 18) }
//     )
    
//     // revertedWith("GlpManager: insufficient USDG output")
//     await xOracle.fulfillRequest([
//       { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(60000), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(300), lastUpdate: 0 }
...
//     // revertedWith("GlpManager: insufficient GLP output")
//     await xOracle.fulfillRequest([
//       { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(60000), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(300), lastUpdate: 0 }
...
//     // revertedWith("GlpManager: insufficient output")
//     await xOracle.fulfillRequest([
//       { tokenIndex: tokenIndexs.USDT, price: toXOraclePrice(1), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BTC, price: toXOraclePrice(60000), lastUpdate: 0 },
//       { tokenIndex: tokenIndexs.BNB, price: toXOraclePrice(300), lastUpdate: 0 }
...
//     // setFulfillController
//     await fulfillController.setHandler(rewardRouterV2.address, true)
//     await rewardRouterV2.setFulfillController(fulfillController.address)
//     await timelock.signalSetHandler(glpManager.address, rewardRouterV2.address, true)

//     await increaseTime(provider, 20)
//     await mineBlock(provider)

//     await timelock.setHandler(glpManager.address, rewardRouterV2.address, true)
...
//     await bnb.mint(user1.address, expandDecimals(1, 18))
//     await bnb.connect(user1).approve(rewardRouterV2.address, expandDecimals(1, 18))
