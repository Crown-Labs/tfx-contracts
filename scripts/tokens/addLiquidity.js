...
async function main() {
  ...
  const usdx = await contractAt("USDX", "0xE14F46Ee1e23B68003bCED6D85465455a309dffF")
  ...
  await sendTxn(usdx.approve(router.address, maxUint256), "usdx.approve(router)")
