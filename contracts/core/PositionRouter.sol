...
contract PositionRouter is BasePositionManager, IPositionRouter {
    ...
    function setFulfillController(address _fulfillController, address _feeReceiver) external onlyAdmin {
        isPositionKeeper[fulfillController] = false;
        fulfillController = _fulfillController;
        feeReceiver = _feeReceiver;
        isPositionKeeper[fulfillController] = true;
    }
